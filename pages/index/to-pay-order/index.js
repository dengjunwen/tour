...
Page({
  ...
  createOrder: function (e) {
    ...
    if (e) {
      var remark = that.data.goodsList[0].label;//备注信息
      if (that.data.goodsList[0].category == 'ticket'){
        remark += "-姓名：" + that.data.goodsList[0].realname + "-手机号：" + that.data.goodsList[0].phone + "-身份证号：" + that.data.goodsList[0].idcard;
      }
    }
    ...
    WXAPI.orderCreate(postData).then(function (res) {
      ...
      // 下单成功，跳转到订单管理界面
      wx.redirectTo({
        url: "/pages/index/order-list/index"
      });
    })
  },
  ...
  addAddress: function () {
    wx.navigateTo({
      url: "/pages/index/address-add/index"
    })
  },
  selectAddress: function () {
    wx.navigateTo({
      url: "/pages/index/select-address/index"
    })
  },
